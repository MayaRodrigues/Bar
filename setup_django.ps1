...
if (-not $env:VIRTUAL_ENV) {
    Write-Host "⚠️  Ambiente virtual não está ativo!" -ForegroundColor Yellow
...
Write-Host "👤 Deseja criar um superusuário agora? (S/N)" -ForegroundColor Yellow
$resposta = Read-Host
...
Write-Host "📊 Deseja popular o banco de dados com os dados dos JSONs? (S/N)" -ForegroundColor Yellow
$resposta = Read-Host
if ($resposta -eq "S" -or $resposta -eq "s") {
