...
# Pergunta se deseja criar superusuario
...
Write-Host "Deseja usar o cardapio pronto (JSON + imagens) para popular o banco? (S/N)" -ForegroundColor Yellow
$resposta = Read-Host
if ($resposta -eq "S" -or $resposta -eq "s") {
    Write-Host "Populando banco de dados com o cardapio pronto (JSON + imagens)..." -ForegroundColor Cyan
